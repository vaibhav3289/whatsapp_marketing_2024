...
<!-- Mirrored from app.gctsoft.in/forgot_password by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Feb 2024 05:01:56 GMT -->
                ...
                <div class="col-md-6 justify-content-center align-items-center">
                    <div class="d-flex justify-content-center align-items-center h-100">
                        ...
                        <div class="headline mb-4">
                                <h2 class="fs-25 fw-6 mb-0">Forgot Password</h2>
                                <div class="text-gray-600">To continue first verify it's you</div>
                            </div>

                            <div class="mb-3">
                                <input type="text" name="email" class="form-control h-45 b-r-6 border-gray-200" value="" placeholder="Enter your email">
                            </div>
