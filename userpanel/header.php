...
list($edate)=mysqli_fetch_array(mysqli_query($link,"select end_date from user where u_id='".$_SESSION['user']."'"));
//echo "select end_date from user where u_id='".$_SESSION['user']."'";exit;
if ($edate < $date) {
   
    header('Location:renew.php?id='.$_SESSION['user']);
}elseif($edate==""){
  ...
  $.ajax({
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <span ><b>Welcome To</b> <strong style="color:#F00;"><?php echo $cname; ?></strong> </h5>
    ...
    <!-- Main Sidebar Container -->
      ...
      <a href="#" class="brand-link" onClick="chng_module('PLANT')"> <img src="<?php echo $path; ?>dist/img/NEW_LOGO.png" alt="DayBook" class="brand-image img-circle elevation-3"
        ...
        <div class="sidebar">
         ...
         <li class="nav-item"><a class="nav-link <?php if($curUrl=="group_detail.php" or $curUrl=="group_form.php" or $curUrl=="update_group.php") echo 'active'; ?>" href="<?php echo $path; ?>group_detail.php"><i class="nav-icon fa fa-users" style="color: #d38236;"></i>&nbsp;
                <p> Whatsapp Group </p>  </a></li>
   
           <li class="nav-item"><a class="nav-link <?php if($curUrl=="contact_detail.php" or $curUrl=="contact_form.php" or $curUrl=="update_contact.php") echo 'active'; ?>" href="<?php echo $path; ?>contact_detail.php"><i class="nav-icon fa fa-phone" style="color: #f04747;"></i>&nbsp;
                <p> Contact </p>  </a></li>
                ...
                <li class="nav-item"> <a href="<?php echo $path; ?>sms_setting.php" class="nav-link <?php if ($curUrl == 'sms_setting.php')  echo 'active';  ?>">   <i class="nav-icon fas fa-cogs fa-lg" style="color: #cfb826;"></i>
                    <p>  WhatsApp Configuration</p>
                  </a></li>
         
			
                <!--    <li class="nav-item"><a href="<?php echo $path; ?>wp_server.php" class="nav-link <?php if ($curUrl == "wp_server.php") { echo 'active'; } ?>" target="_blank"> <i class="nav-icon  fas fa-server fa-lg"></i>
              <p>Server Start </p>
            </a></li>  
             -->
          
                  <li class="nav-item"><a class="nav-link <?php if($curUrl=="wp_send_msg_rpt.php" ) echo 'active'; ?>" href="<?php echo $path; ?>wp_send_msg_rpt.php"><i class="nav-icon fas fa-file" style="color: #29bcc7;"></i>&nbsp;
                <p> Message </p>  </a></li>
            <!-- 
