...
?>
      <form class="form-horizontal" action="phpfiles/new_contact_exe.php" method="post" enctype="multipart/form-data">
...
<?php
$qry=mysqli_query($link,"select * from groupwm where `u_id`='".$_SESSION['user']."' order by g_id ASC");
...
<?php } ?>
           ...
           <div class="form-group col-sm-3 col-xs-6">
            ...
            <div  class="input-group">
             <input  type="text" name="c_name" class="form-control form-control-sm" placeholder="Enter Contact Name"  autocomplete="off"required />
            </div>
          </div>
