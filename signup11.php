			...
			<div class="row no-gutters">
				<div class="col-md-6">
					...
					<input  type="text" name="name" class="form-control h-45 b-r-6 border-gray-200" placeholder="Enter UserName"  autocomplete="off"required />
					 ...
					 <input  type="text" name="mobile" class="form-control h-45 b-r-6 border-gray-200" placeholder="Enter Mobile Number"  onkeyup="javascript:this.value=this.value.replace(/[^0-9^.]/g, '');" maxlength="10" autocomplete="off"required />
