...
<br/>
<h3 class="text-center"><span class="text">Dear <?php echo strtoupper($_SESSION['user_type']['name']); ?><br /> Select Your Package !!.</span> </br>
...
<div class="container">
  <div class="row">
    ...
    <form name="form1" action="<?php echo $path; ?>upi/txnProcess.php" method="post">
      <input type="hidden" name="limit" value="199">
