...
<!-- Mirrored from app.gctsoft.in/signup by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Feb 2024 05:01:45 GMT -->
				...
				<div class="col-md-6">
					...
					<div class="p-50">
						<div class="headline mb-4">
							...
							<div class="text-gray-600">Let's get your account set up</div>
						</div>
						...
						<div class="mb-3">
							   ...
							   <input  type="text" name="name" class="form-control h-45 b-r-6 border-gray-200" placeholder="Enter UserName"  autocomplete="off"required />
						</div>

						<div class="mb-3">
							 <input  type="text" name="email" class="form-control h-45 b-r-6 border-gray-200" placeholder="Enter Email"  autocomplete="off"required />
						</div>

						<div class="mb-3">
							<input  type="text" name="pass" class="form-control h-45 b-r-6 border-gray-200" placeholder="Enter Password"  autocomplete="off"required />
						</div>

						<div class="mb-3">
							<input type="password" name="confirm_password" class="form-control h-45 b-r-6 border-gray-200" value="" placeholder="Confirm Password">
						</div>
						<input type="text" name="mobile" class="form-control h-45 b-r-6 border-gray-200"  onkeyup="javascript:this.value=this.value.replace(/[^0-9^.]/g, '');" value="" placeholder="Enter Mobile Number" maxlength="10">
...
<div class="mb-3">
<button type="submit" class="btn mb-2 btn-dark w-100 mb-md-3 fw-6 text-uppercase fs-16">Login</button>
</div>
<div>
