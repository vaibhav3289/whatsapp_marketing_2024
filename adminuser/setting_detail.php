      ...
      <div class="container-fluid">
        <div class="row mb-2">
           <div class="col-sm-6 col-xs-3">
            <strong>Setting Detail</strong>
          </div>
          <div class="col-sm-6 col-xs-3">
          <ol class="breadcrumb float-right">
              
               <li class="breadcrumb-item"><a class="btn btn-sm btn-info " href="setting_form.php" ><i class="fa fa-plus"></i>&nbsp;Setting</a></li>   &nbsp;
...
<!-- function declaration end -->
                ...
                <table id="example1" class="table table-bordered table-striped table-sm-responsive">
				  ...
				  $i=1;
                      ...
                      while($row=mysqli_fetch_array($res)) {
                       ...
                       list($gname)=mysqli_fetch_array(mysqli_query($link,"select g_name from groupwm where `g_id`='".$row['c_id']."'"));
					    list($uname)=mysqli_fetch_array(mysqli_query($link,"select name from user where `u_id`='".$row['c_id']."'"));
                        ?>
                        <tr>
                        <td><?php echo $i++; ?></td>
        ...
        class="badge bg-success" target="_blank"><i class="fab fa-whatsapp"></i></a> &nbsp; <a href="tel:<?php echo $row['mobile']; ?>"
         class="badge bg-primary" target="_blank"><i class="fas fa-phone-alt"></i></a>
                          ...
                          <td><a href="update_contact.php?id=<?php echo $row['u_id'];?>"class="btn btn-sm btn-primary" title="Edit"><i class="far fa-edit"></i></a>&nbsp;
                          <a href='phpfiles/delete_contact.php?id=<?php echo $row['u_id'];?>'class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
                          </tr>
                        <?php }?>
                </tbody>
              </table>
