...
function del_group(id)
{
	...
	'<button class="btn btn-sm btn-default" data-dismiss="modal">Close</button><button type="button" class="btn btn-sm btn-danger" onClick=document.location.href="<?php echo $path;?>phpfiles/groupdel/'+id+'/<?php echo hash_hmac('sha256','/grouptoken',$_SESSION['token']); ?>">Confirm</button>'
}
</script>
