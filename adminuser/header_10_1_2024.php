  ...
  $.ajax({
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link" onClick="chng_module('PLANT')"> <img src="<?php echo $path; ?>dist/img/NEW_LOGO.png" alt="DayBook" class="brand-image img-circle elevation-3"
        style="opacity: .8"> <b class="brand-text font-weight-light"><B>VACCINE</B></b> </a> 
 ...
 <?php
      if($_SESSION['admin']==1 ) {
             ...
             <li class="nav-item">
              <a href="<?php echo $path;?>home" class="nav-link <?php if($curUrl=="day_home.php") echo 'active'; ?>">
                ...
                <p> Dashboard </p>
                   ...
                   <li class="nav-item"><a class="nav-link <?php if($curUrl=="hospital_detail.php" or $curUrl=="hospital_form.php" or $curUrl=="update_category.php") echo 'active'; ?>" href="<?php echo $path; ?>hospitaldetail"><i class="nav-icon fa fa-hospital"></i>&nbsp;
                <p> Hospital </p>  </a></li>
   
           <li class="nav-item"><a class="nav-link <?php if($curUrl=="doctor_detail.php" or $curUrl=="doctor_form.php" or $curUrl=="update_doctor.php") echo 'active'; ?>" href="<?php echo $path; ?>doctordetail"><i class="nav-icon fa fa-user"></i>&nbsp;
                <p> Doctor </p>  </a></li>
                
                <li class="nav-item"><a class="nav-link <?php if($curUrl=="children_detail.php" or $curUrl=="children_form.php" or $curUrl=="update_children.php") echo 'active'; ?>" href="<?php echo $path; ?>childrendetail"><i class="nav-icon fa fa-child"></i>&nbsp;
                <p> Children </p>  </a></li>
                
                 <li class="nav-item"><a class="nav-link <?php if($curUrl=="group_detail.php" or $curUrl=="group_form.php" or $curUrl=="update_group.php") echo 'active'; ?>" href="<?php echo $path; ?>groupdetail"><i class="nav-icon fa fa-users"></i>&nbsp;
                <p> Vaccine Group </p>  </a></li>
                
               
                  <li class="nav-item"><a class="nav-link <?php if($curUrl=="vaccine_detail.php" or $curUrl=="vaccine_form.php" or $curUrl=="update_vaccine.php") echo 'active'; ?>" href="<?php echo $path; ?>vaccinedetail"><i class="nav-icon fas fa-virus"></i>&nbsp;
                <p> Vaccine</p>  </a></li>
       ...
       WhatsApp Configuration
              ...
              <li class="nav-item"><a class="nav-link <?php if($curUrl=="due_vaccine_report.php" ) echo 'active'; ?>" href="<?php echo $path; ?>duevaccinerpt"><i class="nav-icon fas fa-file"></i>&nbsp;
                <p> Due Vaccine Report </p>  </a></li>
            <li class="nav-item"><a class="nav-link <?php if($curUrl=="given_vaccine.php" ) echo 'active'; ?>" href="<?php echo $path; ?>givenvaccine"><i class="nav-icon fas fa-file"></i>&nbsp;
                <p> Given Vaccine Report </p>  </a></li>
             <li class="nav-item"><a class="nav-link <?php if($curUrl=="advance_vaccine.php" ) echo 'active'; ?>" href="<?php echo $path; ?>advaccine"><i class="nav-icon fas fa-file"></i>&nbsp;
                <p> Advance Vaccine Report </p>  </a></li>
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item"> <a href="<?php echo $path; ?>smssetting" class="nav-link <?php if ($curUrl == 'sms_setting.php')  echo 'active';  ?>">   <i class="nav-icon fas fa-cogs fa-lg"></i>
			...
			// if($wstatusn=='Y'){
			  ?>
                   <li class="nav-item"><a href="<?php echo $path; ?>wpserver" class="nav-link <?php if ($curUrl == "wp_server.php") { echo 'active'; } ?>" target="_blank"> <i class="nav-icon  fas fa-server fa-lg"></i>
              <p>Server Start </p>
            </a></li>  
            
             <?php // }?>
             
                  <li class="nav-item"><a class="nav-link <?php if($curUrl=="wp_send_msg_rpt.php" ) echo 'active'; ?>" href="<?php echo $path; ?>wpsendmsgrpt"><i class="nav-icon fas fa-file"></i>&nbsp;
                <p> Message Report </p>  </a></li>
            
              <li class="nav-item"><a class="nav-link <?php if($curUrl=="wp_pending_msg.php" ) echo 'active'; ?>" href="<?php echo $path; ?>wppendingmsg"><i class="nav-icon fas fa-file"></i>&nbsp;
      ...
      <li class="nav-item">
        <a href="<?php echo $path;?>acclogout" class="nav-link">
